	...
	<body>
		...
		<col style="width: 5%">	
		  ...
		  <tr>
		    ...
		    <td class="tg-llyw" style="color: #dcdcdc"><a href="Leaving.php"><b>ORDER LEAVING</b></a></td>
		  ...
		  <tr>
		    ...
		    <td class="tg-0pky" colspan="8">
		    	<br><h1 style="font-family: Helvetica">Order Leaving Database</h1><br>
		    	<?php
            	$myquery = "SELECT * FROM item LEFT JOIN products ON item.product_id = products.id WHERE stage='3' ";
            	$results = mysqli_query($conn, $myquery);
            	?>
