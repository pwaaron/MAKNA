	...
	<body>
		...
		<col style="width: 5%">	
		  ...
		  <tr>
		    ...
		    <td class="tg-llyw" style="color: #dcdcdc"><a href="Placed.php"><b>ORDER PLACED</b></a></td>
		  ...
		  <tr>
		    ...
		    <td class="tg-0pky" colspan="8">
		    	<br><h1 style="font-family: Helvetica">Order Placed Database</h1><br>
		    	<?php
            	$myquery = "SELECT * FROM item LEFT JOIN products ON item.product_id = products.id WHERE stage='1' ";
            	$results = mysqli_query($conn, $myquery);
            	?>
